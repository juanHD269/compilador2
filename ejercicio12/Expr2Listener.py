...
class Expr2Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Expr2Parser#factor.
    def enterFactor(self, ctx:Expr2Parser.FactorContext):
        pass

    # Exit a parse tree produced by Expr2Parser#factor.
    def exitFactor(self, ctx:Expr2Parser.FactorContext):
        pass
