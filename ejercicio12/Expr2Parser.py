...
class Expr2Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PLUS", "MUL", "NUM", "WS" ]
    ...
    class ExprContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Expr2Parser.TermContext)
            else:
                return self.getTypedRuleContext(Expr2Parser.TermContext,i)


        def PLUS(self, i:int=None):
            if i is None:
                return self.getTokens(Expr2Parser.PLUS)
            else:
                return self.getToken(Expr2Parser.PLUS, i)
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Expr2Parser.FactorContext)
            else:
                return self.getTypedRuleContext(Expr2Parser.FactorContext,i)


        def MUL(self, i:int=None):
            if i is None:
                return self.getTokens(Expr2Parser.MUL)
            else:
                return self.getToken(Expr2Parser.MUL, i)
    ...
    class FactorContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Expr2Parser.RULE_factor
    ...
    def factor(self):
        ...
        localctx = Expr2Parser.FactorContext(self, self._ctx, self.state)
